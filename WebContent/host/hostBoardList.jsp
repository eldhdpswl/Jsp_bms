		...
		<th align="center">
			<c:if test="${cnt > 0}">
				...
				<c:if test="${startPage > pageBlock}">
					<a href="hostBoardList.host">[◀◀]</a>
					<a href="hostBoardList.host?pageNum=${startPage - pageBlock}">[◀]</a>
				</c:if>
				...
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					...
					<c:if test="${i != currentPage}">
						<a href="hostBoardList.host?pageNum=${i}">[${i}]</a>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pageCount > endPage}">
					<a href="hostBoardList.host?pageNum=${startPage + pageBlock}">[▶]</a>
					<a href="hostBoardList.host?pageNum=${pageCount}">[▶▶]</a>
				</c:if>
