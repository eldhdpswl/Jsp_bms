					...
					<th align="center">
						<c:if test="${cnt > 0}">
							...
							<c:if test="${startPage > pageBlock}">
								<a href="memberboardList.mem">[◀◀]</a>
								<a href="memberboardList.mem?pageNum=${startPage - pageBlock}">[◀]</a>
							</c:if>
							...
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								...
								<c:if test="${i != currentPage}">
									<a href="memberboardList.mem?pageNum=${i}">[${i}]</a>
								</c:if>
							</c:forEach>
							...
							<c:if test="${pageCount > endPage}">
								<a href="memberboardList.mem?pageNum=${startPage + pageBlock}">[▶]</a>
								<a href="memberboardList.mem?pageNum=${pageCount}">[▶▶]</a>
							</c:if>
